...
class InputSystem(
    ...
    private val processor: CameraInputController = object : CameraInputController(camera) {
    ...
    override fun inserted(entityId: Int) {
        ...
        entityId.onMapper(planeMapper) {
            if (plane != null) {
                throw IllegalStateException("Adding a second plane entity is not permitted, $plane is the current entity")
            }
            plane = entityId
        }
    }
